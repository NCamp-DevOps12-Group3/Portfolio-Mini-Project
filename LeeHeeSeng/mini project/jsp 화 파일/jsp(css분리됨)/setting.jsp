	...
	<div class="col-9" data-bs-spy="scroll">
		<div class="boardt" data-bs-spy="scroll" >
			<div data-bs-spy="scroll" data-bs-target="#setting-list" data-bs-offset="0" data-bs-smooth-scroll="true" class="scrollspy_gap-2" tabindex="0"><br><br>
				...
				<form action="#" method="get"  style="border: 1px solid rgb(201, 201, 201); padding: 0px;  border-radius: 17px; margin: 0%; width: 100%;">
					<div class="container position-relative"  style="margin-bottom: 20px;margin-bottom: 20px; padding: 0; border-radius: 15px;">
						<div class="modal fade" id="modalPic">
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-head">
										<h3 class="text-lg-center m-3">정보</h3>
									</div>
						...
						<header class=" w-auto h-25 box d-flex align-items-center justify-content-around " style="background-color: #ddd; padding: 0; margin: 0; border-top-left-radius: 15px; border-top-right-radius: 15px;">
							<div class="box d-inline-block " style="border-radius: 16px; margin-left: 10px; margin-top: 20px; margin-bottom: 20px;background-color: #ddd;">
								<img src="img/cat1.jpg" alt="" style="background-color: #ddd;">
							</div>
							<div class="d-inline-block" style="background-color: #ddd;">
								<h2 style="width: 100px;background-color: #ddd; color: black;">이준섭</h2>
								<p style="background-color: #ddd; color: black;">bitcamp502@naver.com</p>
							</div>
							<div class="d-inline-block " style="background-color: #ddd;" >
								<button type="button" style="width: 100px; padding-top: 12px; padding-bottom: 12px; border-radius: 10px; background-color: #333;color: white; float: left;" class="btn  " data-bs-toggle="modal" data-bs-target="#modalPic">
									사진 변경
								</button>
							</div>
						</header>
						<div style="padding: 10px;">
							<label for="siteUrl" class="form-label" >웹 사이트</label>
							<input type="url" name="siteUrl" id="siteUrl" placeholder="웹사이트 주소" class="w-100 form-control" row="2">
							<div class="form-text">연락 사이트나 개인 포폴이 모아진 주소를 입력해 주세요</div>
						</div>
						<div style="padding: 10px;">
							<label for="introduction" class="form-label">소개</label>
							<textarea name="introduction" id="introduction" class="w-100 form-control"></textarea>
				...
				<div style="border: 1px solid rgb(201, 201, 201);padding: 20px;  border-radius: 7px; ">
					...
					<div>
						...
						<div class="modal fade" id="staticpassswordBackdrop"  data-bs-keyboard="false" tabindex="-1" aria-labelledby="passwordchangebtnLabel" aria-hidden="true">
							<div class="modal-dialog modal-dialog-centered">
								<div class="modal-content" >
									<div class="modal-header" style=" margin: 0px; text-align: center; justify-content: center;">
										<h1 class="modal-title fs-5" id="passwordchangebtnLabel-">비밀번호 변경</h1>
									...
									<div class="modal-footer" style=" margin: 0px; text-align: center; justify-content: center;">
										...
										<a href="passwordchangesChk.html" style="color: white;"><button type="button" style="background-color:#DB3545;" class="btn btn-danger"  id="passwordchangebtn">
											비밀번호 변경
							...
							<div class="modal-dialog modal-dialog-centered" >
								<div class="modal-content" >
									<div class="modal-header" >
										<h1 class="modal-title fs-5" id="staticBackdropLabel-accountdelete">계정 삭제</h1>
									...
									<div class="modal-footer">
										...
										<a href="index.html" style="color: white; border-radius: 15px;"><button type="button" style=" background-color: #DB3545; " class="btn btn-danger"  id="aaccountdeletettn">
											계정 삭제
        ...
        document.getElementById('formFile').addEventListener('change', function(event) {
            ...
            if (input.files && input.files[0]) {
                ...
                reader.onload = function(e) {
                    ...
                    imgElement.classList.add('img-fluid', 'mt-2'); // Bootstrap classes for styling
